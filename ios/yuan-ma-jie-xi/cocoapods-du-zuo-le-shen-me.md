...
> 作者: [draveness](https://draveness.me/cocoapods)
>
> 原文: [https://draveness.me/cocoapods](https://draveness.me/cocoapods)
...
#### 手动解析 Podfile <a id="&#x624B;&#x52A8;&#x89E3;&#x6790;-podfile"></a>
...
#### Podfile 的解析 <a id="podfile-&#x7684;&#x89E3;&#x6790;"></a>
...
Milinillo 算法的核心是 [回溯（Backtracking）](https://en.wikipedia.org/wiki/Backtracking) 以及 [向前检查（forward check）](https://en.wikipedia.org/wiki/Look-ahead_%28backtracking%29)，整个过程会追踪栈中的两个状态（依赖和可能性）。
